...
@run_async
def kurumi_about_callback(update, context):
    query = update.callback_query
    if query.data == "kurumi_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="kurumi_back")
                 ]
                ]
            ),
        )
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *KURUMI*
                 \nHere is the [Source Code](https://github.com/Hirojazz/KURUMIBOT) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(kurumi_about_callback, pattern=r"kurumi_")
