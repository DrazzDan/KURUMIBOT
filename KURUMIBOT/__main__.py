...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am an Anime themed group management bot. I will protect your group. You can find my list of available commands with /help.
"""
...
For all command use / [or](https://telegra.ph/file/30fb1b431a05598a96ab5.jpg) ! 
""".format(
    dispatcher.bot.first_name, ""
    if not ALLOW_EXCL else "\nAll commands can either be used with / or !.\nKindly use ! for commands if / is not working\n")

TOKISAKI_IMG = "https://telegra.ph/file/72ad36642004eed32475a.jpg"
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add TSUKASA to your group",
