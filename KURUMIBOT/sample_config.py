...
class Config(object):
    ...
    OWNER_ID = 1670878989 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Zaidaro"
    SUPPORT_CHAT = "dontcome_in"  #Your own group for support, do not add the @
